...
public class ServerDecoderPipeline implements ChannelPipelineFactory {
	...
	// need to find better way to pass server map to ChannelQueue - this way is not ok
	private String nodeId;
	private List<GeneralConf> serverMap;
	
	public ServerDecoderPipeline(String nodeid, List<GeneralConf> servers) {
		this.nodeId = nodeid;
	...
	public ChannelPipeline getPipeline() throws Exception {
		...
		pipeline.addLast("handler", new ServerHandler(nodeId, serverMap));
